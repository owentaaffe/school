...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { email: @tutor.email, first_name: @tutor.first_name, last_name: @tutor.last_name, user_id: @tutor.user_id }
    end
  ...
  test "should update tutor" do
    patch :update, id: @tutor, tutor: { email: @tutor.email, first_name: @tutor.first_name, last_name: @tutor.last_name, user_id: @tutor.user_id }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
