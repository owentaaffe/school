...
Bookstore.create!(title: 'tml and css. Design and build websites', description: 'Jon Duckett has made the very sensible decision that a book on web design should be well designed, should look inviting and should show as much as it tells', author: 'Jon Duckett', price: 11.99 )
